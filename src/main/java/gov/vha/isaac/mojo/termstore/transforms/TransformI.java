...
public abstract interface TransformI
{
	...
	/**
	 * @return a user-friendly, short description of the amount and type of work that was performed
	 */
	public String getWorkResultSummary();
	
	/**
	 * When called, the transformer should write whatever summary / debug / etc data files to the 
	 * specified folder.  Example files might include docbook formatted results, or a csv file for 
	 * debug, etc.  
	 * @throws IOException 
	 */
